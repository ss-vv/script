...
RSGB=""
DSGB=""
ASGB="msites acenter boss-api ccenter fserver main-service message-service pcenter service-activity api boss-service consumer-service lottery mcenter mobile mreport-service service-api boss cache-service cp-schedule lt-service mdcenter mobile-api schedule tcenter lottery-mobile companies-service"
RSPKG="rcenter"
DSPKG=""
ASPKG="msites acenter boss-api ccenter fserver main-service message-service pcenter service-activity api boss-service consumer-service lottery mcenter mobile mreport-service service-api boss cache-service cp-schedule lt-service mdcenter mobile-api schedule tcenter companies-service"
RSTG="play manager rcenter mdcenter"
RSTC=""
ALLPKG="msites mobile-api  acenter boss-api ccenter fserver main-service message-service pcenter service-activity api boss-service consumer-service lottery mcenter mobile mreport-service service-api boss cache-service cp-schedule lt-service mdcenter schedule tcenter lottery-mobile companies-service"
DS3RD=""
AS3RD=""
