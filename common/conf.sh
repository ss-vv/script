...
if [ "$app" == "gather-server" ]  || [ "$app" == "service" ] || [ "$app" == "api" ]  || [ "$app" == "service-api" ]  || [ "$app" == "main-service" ]  || [ "$app" == "api" ] || [ "$app" == "consumer-service" ] || [ "$app" == "lt-service" ] || [ "$app" == "message-service" ] || [ "$app" == "companies-service" ]; then
